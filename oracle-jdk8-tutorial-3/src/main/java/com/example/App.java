...
public class App {
	public static void main(String[] args) {
		...
		// METODOS MAS UTILIZADOS DE LA CLASE Sring
		...
		if (indice != -1)
			System.out.println("Se ha encontrado la cadena a buscar en el indice : " + indice);
		else
			System.out.println("No se ha encontrado la cadena a buscar");
		...
		if ((indice1 = sampleCadena.indexOf(cadenaABuscar3)) != -1)
			System.out.println("Se ha encontrado la cadena a buscar en el indice: " + indice1);
		else
			System.out.println("No se ha encontrado la cadena a buscar");

		// Recupera una parte de la cadena que va desde un indice indicial
		// hasta un incide final

		String subCadena = sampleCadena.substring(12, 19);

		System.out.println("Subcadena resultante del metodo substring: " + subCadena);

		// convertira mayusculas

		System.out.println(sampleCadena.toUpperCase());

		// convertira minusculas
		...
		int indiceEncontrado2 = sampleCadena.toLowerCase().indexOf(cadenaABuscar4.toLowerCase());
		...
		* isEmpty() y isBlank() */
		...
		System.out.println("Resultado de la llamada al metodo isEmpty() " .concat(result));
		...
		* formada por espacios en blanco */
		...
		+ "porque es inmutable : " + sampleString3);
